        ...
        if (club === favTeam) {
            return (
                ...
                <tr data-club={club} className="league-table-fav" data-clubid={clubid} data-leagueid={leagueid} onClick={iconClick} >
                    ...
                    <td className={`px-4 text-left ${status ? 'icon-active' : 'icon-inactive'}`}>
  <div className="football-icon" id='football-icon'>⚽</div>
  {club}
</td>
            ...
            return (
                ...
                <tr data-club={club} className="league-table" data-clubid={clubid} data-leagueid={leagueid} onClick={iconClick} >
                    <th scope="row">{position}</th>
                    <td className={`px-4 text-left ${status ? 'icon-active' : 'icon-inactive'}`}>
  <div className="football-icon" id='football-icon'>⚽</div>{club} </td>
                    <td >{played}</td>
                    <td >{won}</td>
                    <td>{drawn}</td>
                    <td>{lost}</td>
