...
import TeamAutoComplete from "../AutoComplete/index.jsx";
...
function SavedTeamsCard(props) {
  ...
  return (
    <>
      <div className="row d-flex align-items-center justify-content-around me-5 ms-5">
        <div className="card homepagecard col-sm-6 col-md-4 col-lg-3">
          <div className="card-body d-flex flex-column align-items-center justify-content-center">
            ...
            <p className="card-dsfdsftext lihp text-center">Games played: <p className="information">{props.leaguePlayed}</p></p>
      ...
      {/* <div className="card">
        <h4>{props.name}</h4>
        <img src={props.iconSrc} className="card-img-top" alt="..." />
        <div className="card-body">
          <h5 className="card-title">Statistics</h5>
          <p>League: {props.league}</p>
          <p className="card-text">League Position: {props.leaguePosition}</p>
          <p className="card-text">Current Points: {props.currentPoints}</p>
          <p className="card-text">Goals For: {props.goalsFor}</p>
          <p className="card-text">Goals Against: {props.goalsAgainst}</p>
          <p className="card-text">Goals Difference: {props.goalDifference}</p>
          <hr />
          <h5>News</h5>
          <p className="card-text">{props.newsArticle1}</p>
          <p className="card-text">{props.newsArticle2}</p>
          <p className="card-text">{props.newsArticle3}</p>
        </div>
      </div> */}
    </>
  );
